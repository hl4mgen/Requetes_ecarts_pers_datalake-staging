...
WITH
    -- 1. Sélection de la dernière situation connue en staging (TSAC) - Adresses étrangères uniquement
    ...
    last_situation_tlak AS (
        ...
        FROM (
            ...
            FROM tlak_per.lak_pers_adresse_postale_etrangere
            WHERE
...
SELECT
    ...
    'lak_pers_adresse_postale_etrangere' AS Table_Name,
